...
{
    /// <summary>
    /// Payload para atualização de Moto.
    /// Não inclui o ID (vem na rota).
    /// </summary>
    public record class MotoUpdateRequest
    {
        ...
        // ✅ valida formatos: ABC1234 (antigo) ou ABC1D23 (Mercosul)
